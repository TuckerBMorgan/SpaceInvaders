...
void* D3D::operator new(unsigned int memorySize)
{
	...
	float screenDepth, float screenNear)
{
	...
	m_orthoMatrix = XMMatrixOrthographicLH((float)screenWidth/10, (float)screenHeight/10, screenNear, screenDepth);
...
void D3D::GetVideoCardInfo(char* cardName)
{
